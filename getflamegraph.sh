...
# Clear the state to always run node with fresh state
...
tmux new-session -d -s "rnode-benchmark" ./node/target/universal/stage/bin/rnode run -s \
...
./node/target/universal/stage/bin/rnode deploy --phlo-limit 100000000000000 --phlo-price 1 \
--private-key f8d756125e35da03cc66d5b8411881e72ea57f65bd67800f650336d1a9f827fb $1 
echo "Proposing"; ./node/target/universal/stage/bin/rnode propose &
